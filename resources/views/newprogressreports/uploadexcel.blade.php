    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-3 col-sm-6 col-12">
                <a href="https://drive.google.com/drive/folders/16k6AIIdUc5LYC78RNe-A1i_JkslHEL9d?usp=sharing" class="btn btn-success btn-sm btn-block" target="_blank">
                    Download format
                </a>
                </div>
            </div>
            <div class="card-body">
                <form id="uploadForm" action="{{ route('newprogressreports.updateexcel') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group" id="unitField">
                        ...
                        <select name="progressreportname" id="progressreportname" class="form-control" required>
                            @foreach($unitforprogresdokumen as $memberunitforprogresdokumen)
                                <option value="{{$memberunitforprogresdokumen}}">{{$memberunitforprogresdokumen}}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group" id="projectTypeField">
                        <label for="proyek_type">Select Project Type:</label>
                        <select name="proyek_type" id="proyek_type" class="form-control" required>
